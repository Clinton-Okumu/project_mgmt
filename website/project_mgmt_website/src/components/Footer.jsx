...
const Footer = () => {
  return (
    <footer className="bg-[#EAE6FE] py-12 mt-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold text-purple-600">SwiftBoard</span>
            </div>
            <p className="text-gray-600 mb-4">
              The simple project management tool for indie developers and small teams.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-purple-600">Roadmap</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-purple-600">API</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="#" className="text-gray-600 hover:text-purple-600 text-sm">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
